...
*/
		...
		ArbolGeneral<Integer> nodo3 = new ArbolGeneral<Integer>(8);
		...
		ListaGenerica<Integer> listaImpares = parcial.resolver();
		System.out.println("LISTA VALORES: "+listaImpares.toString());
	}
}
